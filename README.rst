...
.. image:: https://github.com/burlesquer/openwisp-notifications/workflows/OpenWISP%20CI%20Build/badge.svg?branch=master
   :target: https://github.com/burlesquer/openwisp-notifications/actions?query=workflow%3A%22OpenWISP+CI+Build%22
   :alt: CI build status
...
.. figure:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/notification-demo.gif
   :align: center
...
.. code-block:: shell
    ...
    pip install https://github.com/burlesquer/openwisp-notifications/tarball/master

Alternatively, you can install via pip using git:

.. code-block:: shell

    pip install -e git+git://github.com/burlesquer/openwisp-notifications#egg=openwisp_notifications
...
.. figure:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/notification-widget.gif
   :align: center
...
.. figure:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/notification-toast.gif
   :align: center
...
.. figure:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/email-template.png
...
<https://github.com/burlesquer/openwisp-utils#openwisp-utils-admin-theme-email-send-email>`_.
...
.. image:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/notification-settings.png
...
.. image:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/silence-notifications.png
   :align: center
...
| type    | ``str``                                                                                   |
+---------+-------------------------------------------------------------------------------------------+
| default | `notification_bell.mp3 <https://github.com/burlesquer/openwisp-notifications/tree/master/ \ |
...
.. image:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/api-docs.png
...
.. image:: https://github.com/burlesquer/openwisp-notifications/raw/docs/docs/images/api-ui.png
...
When in doubt, the code in `test project <https://github.com/burlesquer/openwisp-notifications/tree/master/tests/openwisp2/>`_
and `sample_notifications <https://github.com/burlesquer/openwisp-notifications/tree/master/tests/openwisp2/sample_notifications/>`_
...
.. code-block:: shell
    ...
    pip install -U https://github.com/burlesquer/openwisp-notifications/tarball/master
...
- `sample_notifications/__init__.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/__init__.py>`_.
- `sample_notifications/apps.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/apps.py>`_.
...
`models of the sample app in the test project <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/models.py>`_.
...
Refer to the `admin.py file of the sample app <https://github.com/burlesquer/openwisp-notifications/tests/openwisp2/sample_firmware_upgrader/admin.py>`_.
...
Please refer to the `urls.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/urls.py>`_
...
Please refer to the `routing.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/routing.py>`_
file in the test project.
...
Please refer to the `celery.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/celery.py>`_
file in the test project.
...
<https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/templatetags/notification_tags.py>`_.
...
`sample_notifications/models.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/models.py>`_
...
<https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/tests.py>`_
...
Create a view file as done in `sample_notifications/views.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/views.py>`_
...
Create a consumer file as done in `sample_notifications/consumers.py <https://github.com/burlesquer/openwisp-notifications/blob/master/tests/openwisp2/sample_notifications/consumers.py>`_
...
See `LICENSE <https://github.com/burlesquer/openwisp-notifications/blob/master/LICENSE>`_.
...
`Icons <https://github.com/burlesquer/openwisp-notifications/tree/master/openwisp_notifications/static/openwisp-notifications/images/icons/>`_
...
`Notification sound <https://github.com/burlesquer/openwisp-notifications/tree/master/openwisp_notifications/static/openwisp-notifications/audio>`_
